...
- **[Worked Example](docs/07-worked-example.md)** — two connected fictional scenarios, followed end to end as real (SHACL-validated) RDF individuals, behind the explorer's Example tab and Story page.
