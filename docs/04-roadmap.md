...
- [ ] **Milestone 3 — Graph exploration, part 2:** in-graph search, a deterministic/stable layout across visits, path-finding between two concepts, URL-persisted selection/view, export-as-image, fullscreen mode, a keyboard-accessible list alternative. (4 views and node-shape differentiation already shipped in Phase 3.5 Milestone 3 — this is the remaining slice.)
