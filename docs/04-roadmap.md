...
- [ ] **Milestone 2 — Concept catalogue:** search, category/status/relationship-count filters, alphabetical index, aliases and subclass indicators surfaced on `/concepts` itself (not just per-concept pages), URL-persisted filter state.
