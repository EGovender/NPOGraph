...
- [ ] **Milestone 6 — Story mode polish:** a scenario selector (once Milestone 4 adds more threads to choose between), a lifecycle-stage grouping/progress indicator, "open in graph" per step.
