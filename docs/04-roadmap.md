...
- [ ] **Milestone 4 — Philanthropic intermediary model, remaining slice:** worked-example instance data for the Donor-Advised Fund, Regranting, and Collaborative Fund arrangements (Phase 3.5 only covered Fiscal Sponsorship); simple role-change diagrams; flags on concepts that may warrant legal-consultation review notes. (The concepts themselves already shipped in Phase 3.5 Milestones 1–2.)
