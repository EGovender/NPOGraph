...
`docs/*.md` (numbered `00`–`09`) are the prose spec that `ontology/source/*.json` mirrors into machine-readable form — see `docs/05-data-model.md` before editing anything under `ontology/`, and `docs/04-roadmap.md` for what's done/next (see below).
